...
<head>
	...
	<title>Kelola Produk - Yuneek Store</title>
											...
											<tr>
												...
												<td>
													...
													<button type="button" class="btn btn-danger" data-toggle="modal"
														data-target="#delete<?=$p['idproduk'];?>">
														<i class="fa fa-trash"></i>
													</button>
												</td>
											</tr>
	<!-- Edit Modal -->
	<div id="edit<?=$idb;?>" class="modal fade">
			...
			<div class="modal-content">
				...
				<form method="post" enctype="multipart/form-data">
					<div class="modal-body">
						Nama Produk
						<input type="text" name="namaproduk" value="<?=$p['namaproduk'];?>" class="form-control" required>
						<br>
						Deskripsi
						...
						<br>
						Harga Awal
						<input type="number" name="hargabefore" value="<?=$p['hargabefore'];?>" class="form-control"
							required>
						<br>
